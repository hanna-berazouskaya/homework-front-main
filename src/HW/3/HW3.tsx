...
export const HW3 = () => {
  ...
  const handleChange = (event: ChangeEvent<HTMLInputElement>) => {
      setCurrentText(event.target.value); // Устанавливаем текущий текст из значения ввода
  };

  const handleSave = () => {
      setTexts((prevTexts) => [...prevTexts, currentText]); // Добавляем текущий текст в массив texts
      setCurrentText(''); // Сбрасываем текущий текст
